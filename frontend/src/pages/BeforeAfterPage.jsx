    ...
    <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8 flex items-center justify-center">
      <div className="max-w-4xl w-full">
        <div className="text-center mb-12">
          ...
          />
          <p className="text-xl text-gray-600 px-4">Transforming Simple PDFs into Professional LaTeX Resumes Effortlessly!</p>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-center space-y-8 md:space-y-0 md:space-x-8 mb-12">
          <div className="relative w-[250px] h-[400px] transform -rotate-3 ">
            ...
            />
            <span className="absolute bottom-4 left-4 bg-[#2563EB] text-white px-2 py-1 rounded text-sm font-semibold">Before</span>
          </div>
          ...
          <div className="relative transform rotate-3">
            <Stack
              ...
              cardDimensions={{ width: 270, height: 420 }}
              cardsData={images}
