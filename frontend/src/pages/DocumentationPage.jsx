    ...
    <div className="min-h-screen  py-8 sm:py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center mb-10">
          <button
            onClick={() => navigate("/")}
            className="mr-4 p-2 rounded-lg bg-white hover:bg-gray-100 transition-colors border border-gray-200 "
          >
            <ChevronLeft size={24} />
          </button>
        ...
        <div className="bg-white rounded-lg border border-gray-200  p-6 mb-6">
          ...
          <ol className="space-y-4">
            <li className="flex">
              <div className="flex-shrink-0 bg-blue-600 text-white rounded-full w-6 h-6 flex items-center justify-center mr-3">
                1
              </div>
              <div>
                <h3 className="font-medium text-gray-800">Upload your resume</h3>
            ...
            <li className="flex">
              ...
              <div>
                <h3 className="font-medium text-gray-800">Select a template</h3>
                <p className="text-gray-600 mt-1">
            ...
            <li className="flex">
              ...
              <div>
                <h3 className="font-medium text-gray-800">Process and download</h3>
                <p className="text-gray-600 mt-1">
        ...
        <div className="bg-white rounded-lg border border-gray-200  p-6 mb-6">
          ...
          <div className="space-y-4">
            <div className="border-l-4 border-amber-500 pl-4 py-1">
              <h3 className="font-medium text-gray-800">File Size Limit</h3>
              <p className="text-gray-600 mt-1">
            ...
            <div className="border-l-4 border-amber-500 pl-4 py-1">
              <h3 className="font-medium text-gray-800">Supported Formats</h3>
              <p className="text-gray-600 mt-1">
            ...
            <div className="border-l-4 border-amber-500 pl-4 py-1">
              <h3 className="font-medium text-gray-800">Complex Formatting</h3>
              <p className="text-gray-600 mt-1">
            ...
            <div className="border-l-4 border-amber-500 pl-4 py-1">
              <h3 className="font-medium text-gray-800">Language Support</h3>
              <p className="text-gray-600 mt-1">
            ...
            <div className="border-l-4 border-red-500 pl-4 py-1">
              <h3 className="font-medium text-gray-800">Known Issues</h3>
              <p className="text-gray-600 mt-1">
        ...
        <div className="bg-white rounded-lg border border-gray-200  p-6 mb-6">
          ...
          <ul className="space-y-3">
            {[
              ...
              <li key={index} className="flex items-start">
                <InfoIcon className="text-blue-500 mr-2 mt-1 flex-shrink-0" size={18} />
        ...
        <div className="bg-white rounded-lg border border-gray-200  p-6 mb-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <button
              ...
              className="bg-amber-500 hover:bg-amber-600 text-white py-2 px-4 rounded-lg flex items-center justify-center transition-colors"
            >
              <AlertCircle size={18} className="mr-2" />
              Report a Bug
            </button>
            <a
              href="mailto:resumetex.convertor@gmail.com.com"
