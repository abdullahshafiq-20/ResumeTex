...
const MyResume = () => {
  ...
  return (
    <>
                ...
                <div className="relative group">
                  ...
                  >
                    <div className="py-1">
                      <button
                        onClick={() =>
                          handleDownload(resume._id, resume.resume_link)
                        }
      ...
      <div>
        <PDFCard
          pdfUrl="https://res.cloudinary.com/dlthjlibc/raw/upload/v1746795410/ykow4hjuecwtux7qglvl.pdf"
          imageUrl="https://res.cloudinary.com/dlthjlibc/image/upload/v1746816884/resume_thumbnails/h7hxbsarrmctya9babdq.png"
        />
      </div>
    </>
  );
